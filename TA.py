...
if inp == "1":
    ...
    if inp == "1":
        ...
        if inp == "1":
            ...
            if inp == "2":
                print("You have found out he has been talking to other people all along! You are very smart for following your gut. Remember that no one is worth wasting your time. Enjoy your food, block their number and let them watch your fancy snaps.")
    if inp == "2":
